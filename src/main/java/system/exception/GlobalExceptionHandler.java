...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorObject> handlePokemonNotFoundException(BookNotFoundException ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorObject> handleAuthorNotFoundException(AuthorNotFoundException ex, WebRequest request) {
